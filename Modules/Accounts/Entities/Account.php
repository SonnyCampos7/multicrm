 ...
 * @property-read Currency|null $paymentCurrency
 * @property-read int|null $quotes_count
 * @property-read int|null $service_contracts_count
 * @property-read int|null $tickets_count
 * @method static \Illuminate\Database\Eloquent\Builder|Account whereExtraId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Account wherePaymentConditionId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|Account wherePaymentCurrencyId($value)
 */
