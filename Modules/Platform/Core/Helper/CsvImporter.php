...
class CsvImporter
{
    ...
    public function updateEntity($attributes,$existingRecord){
        ...
        $existingRecord->fill($finalAttributes);
        $existingRecord->save();
        ...
        if ($assginedTo != '') {
            ...
            if (!empty($user)) {
                ...
                $existingRecord->changeOwnerTo($user);
                $existingRecord->save();
            }
            ...
            if (!empty($group)) {
                $existingRecord->changeOwnerTo($group);
                $existingRecord->save();
            }
        }
